...
class AppColors {
  ...
  // ✅ Navigation Bar Background + Shadow
  static LinearGradient get navbarBg => LinearGradient(
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
    colors: ThemeService.instance.isDarkMode
        ? [
            Colors.grey.shade900, // Top
            Colors.black.withOpacity(0.3), // Bottom
          ]
        : [
            Colors.grey.shade900, // Top
            Colors.black.withOpacity(0.3), // Bottom,
  ...
  static Color get navBarShadowColor =>
      ThemeService.instance.isDarkMode ? Colors.white12.withOpacity(0.1) : Colors.white12.withOpacity(0.1);

  // Background
  static LinearGradient get bgColor => ThemeService.instance.isDarkMode ? appBgGradient : appBgGradient;
  ...
  // AppBar
  static LinearGradient get appBarColor => ThemeService.instance.isDarkMode ? bgColor : bgColor;
